...
- 2017-8-28  v3.01 ワイド文字の処理モード見直し等
- 2017-8-28  v3.02 トップレベルコマンドの入力チェックを追加
- 2017-8-29  v3.03 コメント修正のみ
- 2017-8-30  v3.04 タブ文字処理見直し
- 2017-9-1   v3.10 ワイド文字の処理見直し等
- 2017-7-8   v3.11 Gauche v0.9.6 の更新に追従
